...
$(function(){
    $("#add-user").validate({
        ...
        $.post("../../sql/usuarios/Editar.php", str, procesar).error(proerror);
    ...
    <table class="form-content">
        <tr>
            <td class="title" colspan="2">
                <h2 align="center">Editar datos del usuario</h2>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <a class="transparente cancelar" href="index.php"><span>Cancelar</span></a>
